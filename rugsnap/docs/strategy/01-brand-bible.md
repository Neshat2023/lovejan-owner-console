...
**Preliminary trademark risk — updated with LIVE web knockout (2026-07-23 ~21:4x UTC; search-engine level, not a TESS/attorney clearance — full findings & sources in brand/04):** **Veluma — Elevated, demoted:** an active "VELUMA | creative lab" operates veluma.net with veluma.com resolving (active use in adjacent branding services; .com effectively unbuyable). **Valyt — lowest live footprint, promoted to primary-conditional:** zero companies/apps/marks found; nearest marks VALT (2022, alt-investments software) and VALTS (2021, metaverse) need attorney assessment. **Aestima — moderate:** active UK "Aestima Limited" (patent/copyright agents, inc. 2011) in a different country/class; Toyota Estima noise unchanged. Attorney knockout search (classes 9, 35, 36, 42, 45) remains mandatory before any adoption or domain spend.
