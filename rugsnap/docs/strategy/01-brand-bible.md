...
**Preliminary trademark risk (non-legal, UNVERIFIED):** Veluma — lower-apparent; Aestima — moderate (Toyota "Estima" vehicle noise, Latin-root class-36 neighbors likely); Valyt — lower-apparent (payments-class "Vault/Volt" neighbors to check). All three require attorney knockout search (classes 9, 35, 36, 42, 45) before any adoption or domain spend.
